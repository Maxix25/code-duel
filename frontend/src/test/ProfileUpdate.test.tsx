...
describe('ProfileUpdate', () => {
    ...
    it('should render the profile update form after loading', async () => {
        ...
        expect(
            screen.getByLabelText(/current password \(optional\)/i)
        ).toBeInTheDocument();
        expect(
    ...
    it('should show error when trying to change password without current password', async () => {
        ...
        await waitFor(() => {
            expect(
                screen.getByText(
                    /current password is required to change password/i
                )
            ).toBeInTheDocument();
        });
    });
    ...
    it('should display helper text for password fields', async () => {
        ...
        expect(
            screen.getByText(
                /only required if you want to change your password/i
            )
        ).toBeInTheDocument();
        expect(
            screen.getByText(/leave empty to keep current password/i)
        ).toBeInTheDocument();
    });
